<div>
    ...
    <div class="max-w-full  py-5 sm:px-6 lg:px-1 lg:py-7 mx-auto">
        ...
        <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
            ...
            <header class="mb-10 py-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200 dark:border-gray-700">
                ...
                <div>
                    <p class="mb-2 text-sm font-semibold text-blue-600">{{ __('Edit Role') }}</p>
                    <h1 class="block text-2xl font-bold text-gray-800 sm:text-3xl dark:text-white">{{ __('Edit Role') }}</h1>
    ...
    <div class="max-w-full  py-5 sm:px-6 lg:px-1 lg:py-7 mx-auto">
        ...
        <livewire:admin.role.role-permission.list-permission :id="$id"/>
    </div>
