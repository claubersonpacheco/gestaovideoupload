        ...
        <div class="p-4 sm:p-6 space-y-4 sm:space-y-6">
            ...
            <div class="max-w-full  py-5 sm:px-6 lg:px-1 lg:py-7 mx-auto">
                ...
                <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
                    ...
                    <!-- Page Heading -->
                    <header
                        class="mb-10 px-0 py-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200 dark:border-gray-700">
                        <div>
                    ...
                    <div class="grid gap-2 md:flex justify-normal items-center">
                        ...
                        <div class="md:w-1/2 sm:w-full mb-4">
                            <div class="relative" style="padding-top: 56.25%">
                                <iframe class="absolute inset-0 w-full h-full aspect-video"
                                        src="{{ $video->file_path }}?autoplay=false&loop=false&muted=false&preload=true&responsive=true"
                                        loading="lazy"
                        ...
                        <div class="md:w-1/2 sm:w-full mb-4">
                            ...
                            <div class="block rounded-lg bg-white dark:bg-neutral-700 text-center">
                                ...
                                <div class="p-6">
                                    ...
                                    <textarea id="embed" rows="8"
                                              class="w-full block rounded-lg border-gray-300 border-2 dark:border-none dark:bg-neutral-600 py-[9px] px-3 pr-4 text-sm focus:border-blue-400 focus:ring-1 focus:ring-blue-400 focus:outline-none"><iframe height="315" src="{{ $video->file_path }}?autoplay=false&amp;loop=false&amp;muted=false&amp;preload=true&amp;responsive=true" loading="lazy" style="border:0; width:100%;" allow="accelerometer;gyroscope;autoplay;encrypted-media;picture-in-picture;" allowfullscreen="true"></iframe></textarea>
                                    <!-- Button -->
