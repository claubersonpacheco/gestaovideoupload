        ...
        <header class="mb-10 px-0 py-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200 dark:border-gray-700">
            ...
            <div>
                <div class="inline-flex gap-x-2">
                    <a href="{{ route('videos.index') }}" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                       >
            ...
            <div class="md:w-1/2 sm:w-full mb-4">
                ...
                <div class="block rounded-lg bg-white dark:bg-neutral-700 text-center">
                    ...
                    <div class="p-6">
                        ...
                        <textarea id="embed" rows="8" class="w-full block rounded-lg border-gray-300 border-2 dark:border-none dark:bg-neutral-600 py-[9px] px-3 pr-4 text-sm focus:border-blue-400 focus:ring-1 focus:ring-blue-400 focus:outline-none"><iframe height="315" src="{{ $video->file_path }}?autoplay=false&amp;loop=false&amp;muted=false&amp;preload=true&amp;responsive=true" loading="lazy" style="border:0; width:100%;" allow="accelerometer;gyroscope;autoplay;encrypted-media;picture-in-picture;" allowfullscreen="true"></iframe></textarea>
                        <!-- Button -->
