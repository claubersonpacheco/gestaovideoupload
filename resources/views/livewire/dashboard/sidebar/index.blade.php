                ...
                @can('dashboard.index')
                    <li>
                        <a class="flex items-center gap-x-3 py-2 px-2.5 bg-gray-700 text-sm text-white rounded-lg focus:outline-none focus:ring-1 focus:ring-gray-600"
                           href="{{ (\Illuminate\Support\Facades\Auth::user()->is_admin)? route('dashboard.index'): route('dashboard.index') }}">
                        ...
                        <div id="users-accordion-child" class="hs-accordion-content w-full overflow-hidden transition-[height] duration-300 hidden">
                            <ul class="hs-accordion-group ps-3 pt-2" data-hs-accordion-always-open>
                                <li class="hs-accordion" id="users-accordion-sub-2">
                                    <a href="{{ route('videos.index') }}"  class="hs-accordion-toggle w-full text-start flex items-center gap-x-3.5 py-2 px-2.5 hs-accordion-active:text-white hs-accordion-active:hover:bg-transparent text-sm text-gray-400 rounded-lg hover:bg-gray-800 hover:text-white focus:outline-none focus:ring-1 focus:ring-gray-600">
                                        {{ __( 'Videos')}}
                                ...
                                <li class="hs-accordion" id="users-accordion-sub-1">
                                    ...
                                    <div id="users-accordion-sub-1-child" class="hs-accordion-content w-full overflow-hidden transition-[height] duration-300 hidden">
                                        <ul class="pt-2 ps-2">
                                            ...
                                            <li>
                                                <a href="{{ route('folders.videos', $folder->id) }}" class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-400 rounded-lg hover:bg-gray-800 hover:text-white focus:outline-none focus:ring-1 focus:ring-gray-600" >
                                                    {{ $folder->name }}
                                                </a>
                                            </li>
                                            @endforeach
                                ...
                                <li class="hs-accordion" id="users-accordion-sub-2">
                                    <a href="{{ route('videos.create') }}"  class="hs-accordion-toggle w-full text-start flex items-center gap-x-3.5 py-2 px-2.5 hs-accordion-active:text-white hs-accordion-active:hover:bg-transparent text-sm text-gray-400 rounded-lg hover:bg-gray-800 hover:text-white focus:outline-none focus:ring-1 focus:ring-gray-600">
                                        {{ __( 'Create Video')}}

                                    </a>
                                </li>
                                <li class="hs-accordion" id="users-accordion-sub-2">
                                    <a href="{{ route('folders.create') }}"  class="hs-accordion-toggle w-full text-start flex items-center gap-x-3.5 py-2 px-2.5 hs-accordion-active:text-white hs-accordion-active:hover:bg-transparent text-sm text-gray-400 rounded-lg hover:bg-gray-800 hover:text-white focus:outline-none focus:ring-1 focus:ring-gray-600">
                                        {{ __( 'Create Folder')}}
