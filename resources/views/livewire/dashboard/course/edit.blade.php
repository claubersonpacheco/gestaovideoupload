<div>
    ...
    <ol class="flex items-center whitespace-nowrap" aria-label="Breadcrumb">
        ...
        <li class="inline-flex items-center">
            <a class="flex items-center text-sm text-gray-500 hover:text-blue-600 focus:outline-none focus:text-blue-600 dark:focus:text-blue-500" href="{{ route('courses.index') }}">
                {{ __('Courses') }}
                <svg class="flex-shrink-0 mx-2 overflow-visible h-4 w-4 text-gray-400 dark:text-neutral-600" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m9 18 6-6-6-6"/></svg>
            </a>
        </li>
    ...
    <div class="max-w-full  py-5 sm:px-6 lg:px-1 lg:py-7 mx-auto">
        ...
        <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
            ...
            <header class="mb-10 px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200 dark:border-gray-700">
                ...
                <div>
                    <p class="mb-2 text-sm font-semibold text-blue-600">{{ __('Edit') }}</p>
                    <h1 class="block text-2xl font-bold text-gray-800 sm:text-3xl dark:text-white">{{ __('Course') }}</h1>
            ...
            <form wire:submit.prevent="save">
                ...
                <div class="grid sm:grid-cols-12 gap-2 sm:gap-6">
                    ...
                    <div class="sm:col-span-9">
                        <div class="sm:flex">
                            <select wire:model="form.category"  id="category" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">

                                @foreach($categories as $category)

                                    <option @selected($category->id === $data->category->id) value="{{ $category->id }}">{{ $category->name }}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="sm:col-span-9">
                        <div class="sm:flex">
                            <input id="name" wire:model="form.fullname" type="text" class="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" placeholder="Name">

                        </div>
                        <x-input-error class="mt-2" :messages="$errors->get('form.fullname')" />
                    </div>
                    <!-- End Col -->
                    ...
                    <div class="sm:col-span-9">
                        <div class="sm:flex">
                            <input id="shortname" wire:model="form.shortname" type="text" class="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" placeholder="Short name">

                        </div>
                        <x-input-error class="mt-2" :messages="$errors->get('form.shortname')" />
                    </div>
                    <!-- End Col -->
                    ...
                    <div class="sm:col-span-9">
                        <div class="sm:flex">
                            <textarea id="description" wire:model="form.summary" type="text" class="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600">
                            </textarea>

                        </div>
                        <x-input-error class="mt-2" :messages="$errors->get('form.summary')" />
                    </div>
                    <!-- End Col -->

                    <div class="sm:col-span-3">
                        <label for="startdate" class="inline-block text-sm text-gray-800 mt-2.5 dark:text-gray-200">
                            {{ __('Start Date') }}
                        </label>
                    </div>
                    <!-- End Col -->
                    ...
                    <div class="sm:col-span-9">
                        <div class="sm:flex">
                            ...
                            <input id="startdate" value=""  wire:model="form.startdate" type="datetime-local" class="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" placeholder="Short name">

                        </div>
                        <x-input-error class="mt-2" :messages="$errors->get('form.startdate')" />
                    </div>
                    <!-- End Col -->

                    <div class="sm:col-span-3">
                        <label for="enddate" class="inline-block text-sm text-gray-800 mt-2.5 dark:text-gray-200">
                            {{ __('End Date') }}
                        </label>
                    </div>
                    <!-- End Col -->
                    ...
                    <div class="sm:col-span-9">
                        <div class="sm:flex">
                            <input id="enddate" value="" wire:model="form.enddate" type="datetime-local" class="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" placeholder="Short name">

                        </div>
                        <x-input-error class="mt-2" :messages="$errors->get('form.enddate')" />
                    </div>
                    <!-- End Col -->

                    <div class="sm:col-span-3">
                        <label for="visible" class="inline-block text-sm text-gray-800 mt-2.5 dark:text-gray-200">
                            {{ __('Visible') }}
                        </label>
                    </div>
                    <!-- End Col -->
                    ...
                    <div class="sm:col-span-9">
                        <div class="py-3 sm:flex">
                            <label for="hs-at-with-checkboxes-1" class="flex">
                                <input type="checkbox"  wire:model="form.visible" @checked($checked)
