    ...
    <div class="max-w-full  py-5 sm:px-6 lg:px-1 lg:py-7 mx-auto">
        ...
        <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
            ...
            <header class="mb-10 py-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200 dark:border-gray-700">
                ...
                <div>
                    <p class="mb-2 text-sm font-semibold text-blue-600">{{ __('Course') }}</p>
                    <h1 class="block text-2xl font-bold text-gray-800 sm:text-3xl dark:text-white">{{ __('Create Course') }}</h1>
                ...
                <div class="grid sm:grid-cols-12 gap-2 sm:gap-6">
                    ...
                    <div class="sm:col-span-9">
                        <div class="sm:flex">
                            ...
                            <input id="startdate" value="{{ $startdate }}"  wire:model="form.startdate" type="datetime-local" class="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" placeholder="Short name">
                    ...
                    <div class="sm:col-span-9">
                        <div class="sm:flex">
                            <input id="enddate" value="{{ $enddate }}" wire:model="form.enddate" type="datetime-local" class="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" placeholder="Short name">
                    ...
                    <div class="sm:col-span-9">
                           <div class="py-3 sm:flex">
                            <label for="hs-at-with-checkboxes-1" class="flex">
                                <input type="checkbox"  wire:model="form.visible" value=""
