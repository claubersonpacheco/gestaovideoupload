                    ...
                    <div
                        ...
                        <div>
                            <div class="inline-flex gap-x-2">
                                ...
                                <button wire:click="$dispatch('openModal', { component: 'dashboard.course.enrollment.enroll-user', arguments: { courseid: {{ $id }} }  })" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" >
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tr wire:key="12345">
                                ...
                                <td class="h-px w-px whitespace-nowrap">
                                    <div class="ps-6 lg:ps-3 xl:ps-0 pe-6 py-3">
                                        <div class="flex items-center gap-x-3">
                                            ...
                                            <div class="grow">
                                                        <span
                                                            class="block text-sm font-semibold text-gray-800 dark:text-gray-200">{{ $data->user->name }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                <td class="h-px w-px whitespace-nowrap">
                                    <div class="ps-6 lg:ps-3 xl:ps-0 pe-6 py-3">
                                        <div class="flex items-center gap-x-3">
                                            ...
                                            <div class="grow">
                                                        <span
                                                            class="block text-sm font-semibold text-gray-800 dark:text-gray-200">{{ $data->role->description }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="h-px w-px whitespace-nowrap">
                                    <div class="px-6 py-1.5">
                                        ...
                                        <a title="Cadastro Aluno" class="inline-flex items-center gap-x-1 text-sm text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                                        ...
                                        <button class="inline-flex items-center gap-x-1 text-sm text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                                                wire:click="detachUser({{ $data->user->id }})">
                                            <!-- Icon -->
                                            <span class="m-1 inline-flex justify-center items-center w-[46px] h-[46px] rounded-full border-4 border-gray-50 bg-gray-200 text-gray-800 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                        ...
                        @empty
                            ...
                            <tr>
                                ...
                                <td colspan="3" class="h-px w-full whitespace-nowrap">
                                    <div class="w-full text-center ps-6 lg:ps-3 xl:ps-0 pe-6 py-3 ">
