                            ...
                            @forelse($datos as $data)
                                ...
                                <tr wire:key="{{ $data->id }}">
                                    ...
                                    <td class="h-px w-72 whitespace-nowrap">
                                        <div class="px-6 py-3">
                                            <span
                                                ...
                                                @if($data->photo)
                                                 <img class="inline-block size-[38px] rounded-full" src="{{ asset('storage/images/user/'.$data->photo) }}" alt="Image Description">
                                    ...
                                    <td class="h-px w-72 whitespace-nowrap">
                                        <div class="px-6 py-3">
                                            <span
                                                class="block text-sm font-semibold text-gray-800 dark:text-gray-200">{{ $data->username }}</span>
                                        </div>
                                    </td>
                                   ...
                                   <td class="h-px w-72 whitespace-nowrap">
                                    ...
                                    <td class="h-px w-72 whitespace-nowrap">
                                        <div class="px-6 py-3">
                                            <span
                                                class="block text-sm font-semibold text-gray-800 dark:text-gray-200">{{ $data->email }}</span>
                                        </div>
                                    </td>
                                    ...
                                    <td class="h-px w-72 whitespace-nowrap">
                                        <div class="px-6 py-3">
                                            ...
                                            <span
                                                class="block text-sm font-semibold text-gray-800 dark:text-gray-200">{{ $role->name }}
                                            </span>
                                            @endforeach
                                        </div>
                                    </td>
                                    ...
                                    <td class="h-px w-px whitespace-nowrap">
                                        <div class="px-6 py-1.5">
                                                ...
                                                @can('users.suspended')
                                                @if($data->suspended === '0')
                                                <button title="Suspender conta de usuario" wire:click="changeStatus({{ $data->id }})" class="inline-flex items-center gap-x-1 text-sm text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                                                ...
                                                @else
                                                <!-- End Icon -->
                                                <button title="Habilitar conta de usuário" wire:click="changeStatus({{ $data->id }})" class="inline-flex items-center gap-x-1 text-sm text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
...
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                            ...
                                            @can('users.role')
                                            <a title="Acessar função de usuário" class="inline-flex items-center gap-x-1 text-sm text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                                               href="{{ route('users.role', $data->id) }}">
                                                ...
                                                <!-- End Icon -->
                                                    ...
                                                    @can('users.edit')
                                            <a title="Editar usuário" class="inline-flex items-center gap-x-1 text-sm text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                                               href="{{ route('users.edit', $data->id) }}">
                                                ...
                                                <!-- End Icon -->
                                                    ...
                                                    @can('users.edit')
                                                        <a title="Editar Senha" class="inline-flex items-center gap-x-1 text-sm text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M16.5 10.5V6.75a4.5 4.5 0 1 0-9 0v3.75m-.75 11.25h10.5a2.25 2.25 0 0 0 2.25-2.25v-6.75a2.25 2.25 0 0 0-2.25-2.25H6.75a2.25 2.25 0 0 0-2.25 2.25v6.75a2.25 2.25 0 0 0 2.25 2.25Z" />
                                                    ...
                                                    @can('users.destroy')
                                            <a title="Excluir usuário" class="inline-flex items-center gap-x-1 text-sm text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
