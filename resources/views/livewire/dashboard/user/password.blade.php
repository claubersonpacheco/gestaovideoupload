        ...
        <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
            ...
            <header class="mb-10 py-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200 dark:border-gray-700">
                ...
                <div>
                    ...
                    <h1 class="block text-2xl font-bold text-gray-800 sm:text-3xl dark:text-white">{{ __('Edit Password') }} : {{ $user->name }}</h1>
            ...
            <form wire:submit.prevent="save">
                ...
                <div class="grid sm:grid-cols-12 gap-2 sm:gap-6">
                    ...
                    <div class="sm:col-span-9">
                        <div class="sm:flex">
                            <input id="password" wire:model="password" type="password" class="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" placeholder="{{ __('Password') }}">
                    ...
                    <!--row-->
                    <div class="sm:col-span-3">
                        <label for="update_password_password_confirmation" class="inline-block text-sm text-gray-800 mt-2.5 dark:text-gray-200">
                            {{ __('Confirm Password') }}
                        </label>
                    </div>
                    <!-- End Col -->
                    ...
                    <div class="sm:col-span-9">
                        <div class="sm:flex">
                            <input id="update_password_password_confirmation" wire:model="password_confirmation" type="password" class="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm text-sm rounded-lg focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" placeholder="Confirm Password">
