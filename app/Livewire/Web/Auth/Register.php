...
class Register extends Component
{
    ...
    public function rules()
    {
        ...
        return $rules = [
            ...
            'email' => ['required',  'lowercase', Rule::unique('users', 'email')],
            'birthday' => ['required','date'],
            'phone' => ['required','max:15'],
            'mobile' => ['required','max:15'],
            'rg' => ['nullable', 'string', 'max:15' ],
            'cpf' => ['required', 'max:14', Rule::unique('users', 'cpf')],
            ...
            'password_confirmation' => ['required', Password::min('8')->mixedCase()->uncompromised()],
        ];
